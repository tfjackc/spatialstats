...
By summing the count column based on the type of crime we can visualize that arson occurs the most in comparison to DUIs and homicides. Figure 1 represents this calculation with a bar chart.
...
```
**Figure 1.** In combined years 2013 and 2014 Arson is the most common crime followed by DUI, and homicide.

## Temporal patterns associated with each crime 

Now let's dive deeper into the data, and start to visualize information based on when it took place. Based on the 
